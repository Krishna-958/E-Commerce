...
const AppState = (props) => {
  // Prefer an environment variable (Vite): VITE_API_URL. Fallback to localhost for local development.
  // Example .env: VITE_API_URL="http://localhost:1000/api"
  const url = import.meta.env.VITE_API_URL || "http://localhost:1000/api";
